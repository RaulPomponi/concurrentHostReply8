...
public class CUPdfManagerCP {
	...
	private void run(String string1, String string2) throws Exception {
		...
		String filePath = chc.getProfileValue("XXH_CU_770_PATH_AE");
		chc.log("Path = " + filePath);
		String orgId = (String)mapParam.get("ORG_ID");
		String anno = (String)mapParam.get("ANNO");
