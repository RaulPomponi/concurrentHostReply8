...
public class TestInBoxOrdiniCP {
	...
	private String sqlA 	= "select 'A' STATO, ARSS_REQUEST_ID, NOME_FILE, ORIGINE, OGGETTO  from XXX_GESTIONE_ORDINIPO_A_V  WHERE 1=2 and ORG_ID =:1";
...
//	private String sqlInsert = "INSERT INTO xxh_read_mail_ordini_all (READ_MAIL_ORDINE_ID, FILE_NAME, FILE_DATA, DATA_RICEZIONE_MAIL, DATA_ELABORAZIONE, ORG_ID, REQUEST_ID, TIPO_NUM, TIPO_POSTA) VALUES (?,?,EMPTY_BLOB(),?,to_char(sysdate,'DD-MON-RRRR'),?,?,?,?)";
	...
	public static void main(String[] args) {
		/**/
		TestInBoxOrdiniCP obj = new TestInBoxOrdiniCP();
//		String args0 = args[0];
//		String args1 = args[1];
		
//		String args0="/data1/TESTR12/apps/apps_st/appl/xxh/12.0.0/bin/XXH_TEST_HOST";
//		String args1="XXH_TEST_HOST FCP_REQID=38947216 FCP_LOGIN="APPS/A2p0p2s2TE5t1G3m377i" FCP_USERID=5675 FCP_USERNAME="SB002449" FCP_PRINTER="noprint" FCP_SAVE_OUT=Y FCP_NUM_COPIES=0 "Distinta81-070324-12:03:40" """;
// PRODUZIONE
		String args0="/data2/PROD/apps/apps_st/appl/xxh/12.0.0/bin/XXH_TEST_HOST";
		String args1="XXH_TEST_HOST FCP_REQID=38947216 FCP_LOGIN=\"APPS/g3mpr0da9p5\" FCP_USERID=5675 FCP_USERNAME=\"SB002449\" FCP_PRINTER=\"noprint\" FCP_SAVE_OUT=Y FCP_NUM_COPIES=0 \"Distinta81-070324-12:03:40\" \"\"";
		...
		try {
			...
			if (listaPecI!=null && !listaPecI.isEmpty()) {
				...
				for(PecReadBean pec : listaPecI) {
					String esito = "TEST"; //setPecEsito(pec);
