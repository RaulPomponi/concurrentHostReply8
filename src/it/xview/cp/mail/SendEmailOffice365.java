...
//    private static final String CONTA_PADRAO = "cu770gac@gemelliacasa.it";
//    private static final String SENHA_CONTA_PADRAO = "cu@770.GAC";
    protected static String CONTA_PADRAO = "";
    protected static String SENHA_CONTA_PADRAO = "";
    private  String from = "";
    private  String to = "";
...
//            message.setText(messageContent);
    ...
    public static void main(final String[] args) {
		SendEmailOffice365 s =new SendEmailOffice365();
